...
public class AccountRef {
  ...
  @Schema(name = "id", description = "Unique identifier of the account", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("id")
  public String getId() {
    return id;
  }
   ...
   */
  @NotNull 
  @Schema(name = "name", description = "Name of the account", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("name")
  ...
  public AccountRef atSchemaLocation(URI atSchemaLocation) {
