...
public class PaymentMethodRef {
   ...
   */
  @NotNull 
  @Schema(name = "id", description = "Unique identifier of the payment mean", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("id")
  public String getId() {
    return id;
  }
  ...
  @Schema(name = "href", description = "Reference of the payment mean", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("href")
  ...
  @Schema(name = "name", description = "Name of the payment mean", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("name")
  ...
  public PaymentMethodRef atSchemaLocation(URI atSchemaLocation) {
