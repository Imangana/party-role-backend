...
@Schema(name = "PartyRole_Create", description = "The part played by a party in a given context. Skipped properties: id,href")
@JsonTypeName("PartyRole_Create")
...
public class PartyRoleCreate {
   ...
   */
  public PartyRoleCreate(String name) {
    this.name = name;
  }
  ...
  @Schema(name = "name", description = "A word, term, or phrase by which the PartyRole is known and distinguished from other PartyRoles.", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("name")
  ...
  public PartyRoleCreate account(List<@Valid AccountRef> account) {
  ...
  public PartyRoleCreate agreement(List<@Valid AgreementRef> agreement) {
  ...
  public PartyRoleCreate characteristic(List<@Valid Characteristic> characteristic) {
  ...
  public PartyRoleCreate contactMedium(List<@Valid ContactMedium> contactMedium) {
  ...
  public PartyRoleCreate creditProfile(List<@Valid CreditProfile> creditProfile) {
  ...
  public PartyRoleCreate paymentMethod(List<@Valid PaymentMethodRef> paymentMethod) {
  ...
  public PartyRoleCreate relatedParty(List<@Valid RelatedParty> relatedParty) {
  ...
  public PartyRoleCreate atBaseType(String atBaseType) {
  ...
  public PartyRoleCreate atSchemaLocation(URI atSchemaLocation) {
  ...
  public PartyRoleCreate atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, partyRoleCreate.name) &&
        ...
        Objects.equals(this.atBaseType, partyRoleCreate.atBaseType) &&
        Objects.equals(this.atSchemaLocation, partyRoleCreate.atSchemaLocation) &&
        Objects.equals(this.atType, partyRoleCreate.atType);
  }
