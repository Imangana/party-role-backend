...
import java.net.URI;
import org.openapitools.model.MediumCharacteristic;
...
public class ContactMedium {
   ...
   */
  public ContactMedium(String mediumType, MediumCharacteristic characteristic) {
  ...
  @Schema(name = "mediumType", description = "Type of the contact medium, such as: email address, telephone number, postal address", requiredMode = Schema.RequiredMode.REQUIRED)
   ...
   */
   @Valid
  @Schema(name = "characteristic", requiredMode = Schema.RequiredMode.REQUIRED)
